    ...
    var actionStep = {
        ...
        clickNextButton: function () {
            ...
            $('#btnNext').on('click', function () {
                ...
                var url = `/StepMaker/${currentStepName}`; // url to controller

                //validate input
                if (currentStepName === "_Step1_PV") {
                    inValid = true;
                }
                else if (currentStepName === "_Step2_PV") {
                    inValid = true;
                }
                else if (currentStepName === "_Step3_PV") {
                    inValid = true;
                }
                else if (currentStepName === "_Step4_PV") {
                ...
                if (inValid) {
                    ...
                    if (selected.length > 0) {
                        ...
                        url = `/StepMaker/${selectedStepNameCurrent}`; //change url to controller
                    }
                    ...
                    if (currentStepNumber === "4" || selectedStepNumber === "4") {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {                          
                            ...
                            setTimeout(function () {
                                ...
                                if (parseInt(currentStepNumber) < 4) {
                                ...
                                if (parseInt(currentStepNumber) === 4) {
                                    $('.modal-steps .step:nth-child(4)').addClass('completed');
                                    $('.modal-steps .step:nth-child(4)').children('.dot').css('--completed', `${iconColors[4]}`);
                                    $('.modal-steps .step:nth-child(4)').children('.dot').css('background-color', `${iconColors[4]}`);
                                }
                                ...
                                if (parseInt(currentStepNumber) === 4) {
                                    ...
                                    $(".step[data-step='4'] .dot").prop('disabled', true);
        ...
        clickPrevButton: function () {
            $('#btnPrev').on('click', function () {
                ...
                //set url
                var url = `/StepMaker/${actionName}`; // url to controller
